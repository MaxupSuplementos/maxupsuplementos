...
function onOpen() {
  SpreadsheetApp.getUi()
    ...
    .addSeparator()
    .addItem('⚙️ Configurar recordatorios de recompra', 'configurarRecordatoriosRecompra')
    .addItem('🧪 Probar recompra en Telegram (sin emails)', 'probarRecordatoriosRecompra')
    .addSeparator()
